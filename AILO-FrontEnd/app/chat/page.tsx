...
interface Message {
  ...
  role: "assistant" | "user"; // adjust based on your application
  content: string;
}
export default function Home() {
  ...
  const onSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_SERVER_URL}/context/query-embedding`,
      {
        method: "POST",
        headers: {
